...
// handle operations for starting app defined, render result will be presented in index
...
// todolist operations defined
// form actions(update/delete/edit)
class TodoList extends React.Component {
    constructor(props) {
        ...
        //TODO: debug handleItemCheckboxChange 17.08.18
    ...
    handleUpdateItem(listId, itemId) {
        console.log("handleItemNameChange");
        //TODO: update null should be prevented 17.08.18
        let updatedItem = {
    ...
    render() {
        ...
        let handleRefreshItem = this.handleRefreshItem;
...
// simple update/delete functions implemented
class EditUpdateDeleteObject extends React.Component {
    ...
    handleUpdateButtonClick(objId) {
        ...
        //TODO updating to 'null' is still a problem 19.08.18
                ...
                <FormGroup>
                    <InputGroup>
                        <FormControl
                            ...
                            value={this.props.updatedItemName}
                        ...
                        <InputGroup.Button>
                            <Button  bsStyle="default" onClick={() => this.handleCancelButtonClick()}>Cancel</Button>
                        </InputGroup.Button>
                    </InputGroup>
                </FormGroup>
            </form>
        ...
        return (
            <form onSubmit={this.handleSubmit}>
                <FormGroup>
                    ...
                    <InputGroup.Button>
                        <Button bsStyle="default" onClick={this.handleClick}>Create List</Button>
                    </InputGroup.Button>
                </FormGroup>
            </form>
        );
...
// operations for to-do list object's
class TodoLists extends React.Component {
    ...
    toggleEditingOff() {
        this.setState({editing: ''});
        //TODO setState should be debugged! 17.08.18
    }
    ...
    renderNameOrEditField(list) {
        if (this.state.editing === list.id) {
            ...
            return (
                ...
                <Button bsStyle="danger" onClick={() => this.props.onDeleteList(list.id)}>Delete</Button>
                </h3>
            )
        }
    }
